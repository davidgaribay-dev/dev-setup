...
variable "vm_id" {
  description = "VM ID for the Neo4j server"
  type        = number
  default     = 150
}

variable "vm_name" {
  description = "Name of the Neo4j VM"
  type        = string
  default     = "neo4j-db"
}
...
variable "ip_address" {
  description = "Static IP address in CIDR notation (e.g., '10.0.70.50/24')"
  type        = string
  default     = "10.0.70.50/24"
}
